...
#elif defined(__GNUC__) || defined(__INTEL_COMPILER) || (defined(__SUNPRO_C) && __SUNPRO_C >= 0x590) || \
...
ZMQ_EXPORT int zmq_socket_monitor_versioned(void *s_, const char *addr_, uint64_t events_, int event_version_,
                                            int type_);
